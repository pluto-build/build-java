...
import build.pluto.buildjava.test.simple.BulkBuildTest;
...
@RunWith(Suite.class)
@SuiteClasses({ SimpleJavaBuildTest.class, MultipleFilesTest.class, CyclicFilesTest.class, BulkBuildTest.class })
