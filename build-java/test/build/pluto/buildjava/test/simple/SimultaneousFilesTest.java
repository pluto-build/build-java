...
public class SimultaneousFilesTest extends ScopedBuildTest {
	...
	private TrackingBuildManager build() throws IOException {
		...
		BuildRequirement<None> req = manager.require(JavaBuilder.request(new JavaInput(sourceFiles, targetDir, sourcePath)));
